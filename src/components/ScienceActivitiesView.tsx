          ...
          <div className="space-y-3.5 max-w-3xl">
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              <span className={`text-xs font-mono font-bold px-3 py-1 rounded-full border ${
                ...
                20-Year CBSE Practical-Based Questions (PBQs) Included
              </span>
            </div>
            ...
            <p className={`text-sm sm:text-base leading-relaxed ${isDark ? "text-slate-300 font-normal" : "text-slate-700 font-medium"}`}>
              Every single experimental activity from the NCERT textbook, structured line-by-line with aim, visual apparatus diagrams, step-by-step procedures, instant color change transformation indicators, balanced equations, and 20 years of authentic CBSE Board PBQs.
            </p>
          </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-3 shrink-0 self-end sm:self-auto">
                    <span className="text-xs font-mono font-bold text-cyan-400 hidden sm:inline">
                      {isExpanded ? "Collapse Details" : "View Schematic, Procedure & PYQs"}
                    </span>
                ...
                {isExpanded && (
                  <div className={`px-6 sm:px-8 pb-8 pt-4 border-t space-y-7 ${
                    ...
                    {/* Visual Apparatus Schematic Diagram */}
                    <div className="pt-2">
