...
const METRO_STATIONS: Record<"ch1_europe" | "ch2_india", MetroStation[]> = {
  ch1_europe: [
    ...
    { id: "eu_1871_kaiser_versailles", year: "1871", emoji: "🪞⚔️", label: "German Empire" }
  ],
  ch2_india: [
    ...
    { id: "in_1917_kheda", year: "1917", emoji: "🌾🤲", label: "Kheda Satyagraha" },
    { id: "in_1918_ahmedabad", year: "1918", emoji: "🧵✊", label: "Ahmedabad Mill Strike" },
    { id: "in_1919_march_rowlatt", year: "1919", emoji: "🚫📜", label: "Rowlatt Black Act" },
    { id: "in_1919_13april_jallianwala", year: "1919", emoji: "🕊️🩸", label: "Jallianwala Bagh" },
    { id: "in_1920_dec_nagpur", year: "1920", emoji: "🤝📜", label: "Nagpur NCM Adopted" },
    { id: "in_1921_jan_ncm_launched", year: "1921", emoji: "🧶🎓", label: "NCM Movement Begins" },
    { id: "in_1922_chauri_chaura", year: "1922", emoji: "🚒🛑", label: "Chauri Chaura" },
    { id: "in_1928_simon_arrives", year: "1928", emoji: "📜🚫", label: "Simon Go Back" },
    { id: "in_1929_dec_lahore_purna_swaraj", year: "1929", emoji: "🚩❄️", label: "Purna Swaraj" },
    { id: "in_1930_dandi_march", year: "1930", emoji: "🧂🌊", label: "Dandi Salt March" },
    { id: "in_1931_5march_gandhi_irwin", year: "1931", emoji: "🤝🕊️", label: "Gandhi-Irwin Pact" },
