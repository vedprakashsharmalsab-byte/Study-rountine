...
{activeTab === "experiments" && (
        ...
        {/* ===================== TAB: CHAPTER COMMAND (EXECUTIVE WHITE HABIT ARCHITECTURE) ===================== */}
        {activeTab === "chapter_dashboard" && (
          <CommandCenterHomeView
            isDark={isDark}
            commandSubjectId={commandSubjectId}
            setCommandSubjectId={setCommandSubjectId}
            commandChapterId={commandChapterId}
            setCommandChapterId={setCommandChapterId}
            completedTopicIds={completedTopicIds}
            toggleTopic={toggleTopic}
            myMistakes={myMistakes}
            customFlashcards={customFlashcards}
            activeVaultQuestions={activeVaultQuestions}
            activeVaultChapter={activeVaultChapter}
            playSound={playSound}
            handleNavClick={handleNavClick}
            getTabHref={getTabHref}
            setActiveTab={setActiveTab}
            setConceptsSubject={setConceptsSubject}
            setConceptsChapterNo={setConceptsChapterNo}
            setActiveVaultSubject={setActiveVaultSubject}
