...
export const CH9_QUESTIONS: VaultQuestion[] = [
  {
    "id": "vq_9_1m_1",
    "chapter": 9,
    ...
    "steps": [
      ...
      "Step 2: sin 60° = height/ladder → √3/2 = h/10 → h = 5√3 m. [Trigonometric Definition/Identity]",
      "Step 3: Final statement: 5√3 m [Final Result with Units]"
    ],
  ...
  },
  {
    ...
    "steps": [
      "Step 1: State given values and applicable theorem/formula. [Given in Problem]",
      "Step 2: By alternate angles, angle of elevation from car = 30°. tan30° = 150/d → 1/√3 = 150/d → d = 150√3 m. [Trigonometric Definition/Identity]",
      "Step 3: Final statement: 150√3 m [Final Result with Units]"
    ],
    "source": "CBSE Board / KVS Support / RD Sharma",
    "formula": "tan θ = Opposite / Adjacent",
    "examinerNote": "Double-check units and arithmetic calculations. Write the final answer clearly."
  },
  {
    ...
    "steps": [
      "Step 1: State given values and applicable theorem/formula. [Given in Problem]",
      "Step 2: tan θ = height/shadow = 6/(2√3) = 3/√3 = √3 → θ = 60°. [Trigonometric Definition/Identity]",
  ...
  },
  {
    ...
    "answer": "200(√3−1) m",
    "steps": [
      "Step 1: Near ship: d₁ = 200/tan45° = 200 m [Trigonometric Definition/Identity]",
      "Step 2: Far ship: d₂ = 200/tan30° = 200√3 m [Trigonometric Definition/Identity]",
      "Step 3: Distance = 200√3 − 200 = 200(√3−1) m. [Trigonometric Definition/Identity]"
    ],
    "source": "CBSE Board / KVS Support / RD Sharma",
    "formula": "tan θ = Opposite / Adjacent",
    "examinerNote": "Double-check units and arithmetic calculations. Write the final answer clearly."
  },
  {
    ...
    "answer": "∞ (undefined)",
    "steps": [
      "Step 1: At 90° elevation, tan90° is undefined [Trigonometric Definition/Identity]",
      "Step 2: Physically it means the observer is at the base of the building (directly below the top), height cannot be determined by this method. [Using Empirical Formula: Mode = 3 Median - 2 Mean]"
    ],
    "source": "CBSE Board / KVS Support / RD Sharma",
    "formula": "tan θ = Opposite / Adjacent",
    "examinerNote": "Double-check units and arithmetic calculations. Write the final answer clearly."
  },
  {
    ...
    "steps": [
      "Step 1: State given values and applicable theorem/formula. [Given in Problem]",
      "Step 2: sin 45° = 60/l → 1/√2 = 60/l → l = 60√2 m. [Trigonometric Definition/Identity]",
      "Step 3: Final statement: 60√2 m [Final Result with Units]"
    ],
    "source": "CBSE Board / KVS Support / RD Sharma",
    "formula": "tan θ = Opposite / Adjacent",
    "examinerNote": "Double-check units and arithmetic calculations. Write the final answer clearly."
  },
  {
    ...
    "steps": [
      ...
      "Step 3: Total height = AE + observer height = 28.5 + 1.5 = 30 m. [Final Result with Units]"
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      "Step 3: Distance between tops = √(5² + 12²) = √(25+144) = √169 = 13 m. [Trigonometric Definition/Identity]"
    ],
    "source": "CBSE Board / KVS Support / RD Sharma",
    "formula": "tan θ = Opposite / Adjacent",
    "examinerNote": "Double-check units and arithmetic calculations. Write the final answer clearly."
  ...
  },
  {
    ...
    "steps": [
      ...
      "Step 3: Final statement: h = 60 × tan30° = 60/√3 = 20√3 m [Trigonometric Definition/Identity]"
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      "Step 3: Final statement: String = 40√3 m; horizontal distance = 20√3 m [Trigonometric Definition/Identity]"
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      "Step 3: Final statement: Flagstaff = 10(√3 − 1) m [Final Result with Units]"
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      "Step 3: From depression angle: tan45° = AB/BE → x = 7 m [Trigonometric Definition/Identity]",
      "Step 4: From elevation angle: tan60° = CE/BE → CE = 7√3 m [Trigonometric Definition/Identity]",
      "Step 5: Total tower = CE + ED = 7√3 + 7 = 7(√3+1) m. [Final Result with Units]"
    ],
  ...
  },
  {
    ...
    "steps": [
      ...
      "Step 3: Ships on opposite sides → total = 100√3 + 100 = 100(√3+1) m. [Final Result with Units]"
    ],
  ...
  },
  {
    ...
    "formula": "tan θ = Opposite / Adjacent",
    "examinerNote": "Always sketch a neat labeled diagram with right angle at the base."
  },
  {
    "id": "vq_9_board_21",
    "chapter": 9,
  ...
  },
  {
    ...
    "steps": [
      ...
      "In right △ODB: tan 30° = BD / OD ⟹ 1/√3 = 3000√3 / OD ⟹ OD = 3000√3 × √3 = 9000 m. [Second distance]",
      "Distance travelled CD = OD - OC = 9000 - 3000 = 6000 m. [Distance = 6000 m]",
      "Part (iii): Speed = Distance / Time = 6000 m / 30 s = 200 m/s.",
      "Speed in km/h = 200 × (18/5) = 40 × 18 = 720 km/h. [Final Speed = 720 km/h]"
    ],
    "formula": "tan θ = Opp/Adj and Speed (km/h) = Speed (m/s) × 18/5",
