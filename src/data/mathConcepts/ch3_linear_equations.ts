      ...
      formulasOrKeyPoints: [
        {
          ...
          content: "$$\\begin{array}{|c|c|c|c|} \\hline \\textbf{Ratio Condition} & \\textbf{Graphical Meaning} & \\textbf{Algebraic Solutions} & \\textbf{System Status} \\\\ \\hline \\frac{a_1}{a_2} \\neq \\frac{b_1}{b_2} & \\text{Intersecting Lines} & \\text{Exactly 1 (Unique)} & \\text{Consistent} \\\\ \\hline \\frac{a_1}{a_2} = \\frac{b_1}{b_2} = \\frac{c_1}{c_2} & \\text{Coincident (Overlapping)} & \\text{Infinitely Many} & \\text{Dependent Consistent} \\\\ \\hline \\frac{a_1}{a_2} = \\frac{b_1}{b_2} \\neq \\frac{c_1}{c_2} & \\text{Parallel Lines} & \\text{Zero (No Solution)} & \\text{Inconsistent} \\\\ \\hline \\end{array}$$",
        ...
        },
        {
          ...
          content: "Problem: For what value of $k$ does the system have no solution?  \n$$kx + 3y = k - 2 \\qquad 12x + ky = k$$  \n1. For no solution: $\\frac{a_1}{a_2} = \\frac{b_1}{b_2} \\neq \\frac{c_1}{c_2} \\implies \\frac{k}{12} = \\frac{3}{k} \\neq \\frac{k-2}{k}$.  \n2. From $\\frac{k}{12} = \\frac{3}{k} \\implies k^2 = 36 \\implies k = \\pm 6$.  \n3. Check inequality $\\frac{3}{k} \\neq \\frac{k-2}{k}$:  \n   - If $k = 6$: $\\frac{3}{6} \\neq \\frac{4}{6}$ ($1/2 \\neq 2/3$ True! $\\implies k = 6$ accepted).  \n   - If $k = -6$: $\\frac{3}{-6} = -1/2$, and $\\frac{-8}{-6} = 4/3$ (True! $\\implies k = -6$ accepted).",
          note: "Always verify the inequality $\\neq \\frac{c_1}{c_2}$! If a value of $k$ makes all 3 ratios equal, it gives infinite solutions instead of no solution."
        }
      ],
      stepByStepGuide: [
        {
