...
export const CH13_STATISTICS_CONCEPT: MathChapterConcept = {
  ...
  analogyContent: "Imagine measuring heights of 100 students:  \n$\\bullet$ **Mean ($\bar{x}$)**: The physical balance point! If the students sat on a giant seesaw, the Mean is the exact fulcrum point where the seesaw balances horizontally.  \n$\\bullet$ **Median ($M$)**: The middle child! Line up all 100 students in increasing height order. The student standing exactly at spot #50 is the Median.  \n$\\bullet$ **Mode ($Z$)**: The celebrity in the crowd! The single most common height that appears more times than any other.",
  sections: [
    {
