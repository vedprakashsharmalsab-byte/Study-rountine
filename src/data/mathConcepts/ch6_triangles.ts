...
export const CH6_TRIANGLES_CONCEPT: MathChapterConcept = {
  ...
  analogyContent: "Imagine taking a photo of a triangle and putting it in a photocopier.  \nIf you print at **100% scale**, the copy has the exact same shape and exact same size: they are **Congruent ($\cong$)**!  \nIf you print at **200% zoom** or shrink to **50%**, the copy still has the exact same angles and shape, but all side lengths have doubled or halved in exact proportion: they are **Similar ($\\sim$)**!  \nAll congruent figures are similar, but similar figures are not necessarily congruent.",
  sections: [
    {
      ...
      explanation: "Two polygons with the same number of sides are **similar** if and only if **BOTH** of the following conditions hold:  \n\n1. **All corresponding angles are strictly EQUAL**:  \n   $$\\angle A = \\angle D, \\quad \\angle B = \\angle E, \\quad \\angle C = \\angle F$$  \n\n2. **All corresponding sides are in the EXACT SAME RATIO (Proportional)**:  \n   $$\\mathbf{\\frac{AB}{DE} = \\frac{BC}{EF} = \\frac{AC}{DF} = k} \\quad (\\text{Scale Factor } k)$$  \n\n**Universal Facts for MCQs:**  \n$\\bullet$ All circles are similar (always round!).  \n$\\bullet$ All squares are similar (all angles $90^\\circ$, all sides equal).  \n$\\bullet$ All equilateral triangles are similar (all angles $60^\\circ$).  \n$\\bullet$ Two rectangles are NOT necessarily similar (angles are $90^\\circ$, but sides can have different aspect ratios like $2:1$ vs $5:1$).",
      formulasOrKeyPoints: [
        {
          title: "Symbolic Notation & Correspondence Order Rule",
          content: "$$\\triangle ABC \\sim \\triangle DEF \\implies \\begin{cases} \\angle A = \\angle D, \\; \\angle B = \\angle E, \\; \\angle C = \\angle F \\\\ \\frac{AB}{DE} = \\frac{BC}{EF} = \\frac{AC}{DF} \\end{cases}$$",
      ...
      stepByStepGuide: [
        {
          ...
          action: "From $\\triangle \\mathbf{AB}\\mathbf{C} \\sim \\triangle \\mathbf{DE}\\mathbf{F}$, take 1st-2nd letters ($AB/DE$), 2nd-3rd letters ($BC/EF$), and 1st-3rd letters ($AC/DF$).",
    ...
    },
    {
      ...
      explanation: "**Statement (Theorem 6.1)**:  \n*If a line is drawn parallel to one side of a triangle to intersect the other two sides in distinct points, the other two sides are divided in the same ratio.*  \n\n**Given**: $\\triangle ABC$ where line $DE \\parallel BC$, intersecting $AB$ at $D$ and $AC$ at $E$.  \n**To Prove**:  \n$$\\mathbf{\\frac{AD}{DB} = \\frac{AE}{EC}}$$  \n\n**Construction**:  \n1. Join $B$ to $E$ and $C$ to $D$.  \n2. Draw perpendiculars: $DM \\perp AC$ and $EN \\perp AB$.",
      formulasOrKeyPoints: [
        {
          title: "The Complete Formal 4-Step CBSE Proof",
          content: "**Step 1: Areas with respect to base $AB$**  \n$$\\text{ar}(\\triangle ADE) = \\frac{1}{2} \\times AD \\times EN \\qquad \\text{ar}(\\triangle BDE) = \\frac{1}{2} \\times DB \\times EN$$  \n$$\\implies \\frac{\\text{ar}(\\triangle ADE)}{\\text{ar}(\\triangle BDE)} = \\frac{\\frac{1}{2} \\cdot AD \\cdot EN}{\\frac{1}{2} \\cdot DB \\cdot EN} = \\mathbf{\\frac{AD}{DB}} \\qquad \\text{--- (1)}$$  \n\n**Step 2: Areas with respect to base $AC$**  \n$$\\text{ar}(\\triangle ADE) = \\frac{1}{2} \\times AE \\times DM \\qquad \\text{ar}(\\triangle CDE) = \\frac{1}{2} \\times EC \\times DM$$  \n$$\\implies \\frac{\\text{ar}(\\triangle ADE)}{\\text{ar}(\\triangle CDE)} = \\frac{\\frac{1}{2} \\cdot AE \\cdot DM}{\\frac{1}{2} \\cdot EC \\cdot DM} = \\mathbf{\\frac{AE}{EC}} \\qquad \\text{--- (2)}$$  \n\n**Step 3: Equal Area Property of Same Parallels**  \n$\\triangle BDE$ and $\\triangle CDE$ lie on the same base $DE$ between the same parallels $DE \\parallel BC$:  \n$$\\mathbf{\\text{ar}(\\triangle BDE) = \\text{ar}(\\triangle CDE)} \\qquad \\text{--- (3)}$$  \n\n**Step 4: Conclusion**  \nFrom (1), (2), and (3), the left-hand sides are equal:  \n$$\\mathbf{\\frac{AD}{DB} = \\frac{AE}{EC}} \\qquad \\mathbf{[Hence\\ Proved!]}$$",
        ...
        },
        {
          ...
          content: "Adding 1 to both sides gives the whole-side ratios:  \n$$\\frac{AD}{DB} + 1 = \\frac{AE}{EC} + 1 \\implies \\mathbf{\\frac{AB}{DB} = \\frac{AC}{EC}} \\qquad \\text{and} \\qquad \\mathbf{\\frac{AD}{AB} = \\frac{AE}{AC}}$$",
      ...
      stepByStepGuide: [
        {
          ...
          action: "Never write $\\frac{AD}{DB} = \\frac{AE}{EC}$ as an initial equation. Compute LHS $= 2/3$ and RHS $= 4/6 = 2/3$ separately, then show they are equal.",
          proTip: "State: 'Since $\\frac{AD}{DB} = \\frac{AE}{EC}$, by the Converse of Basic Proportionality Theorem, $DE \\parallel BC$.'"
        }
      ],
      examinerTraps: [
        {
    ...
    },
    {
      ...
      examinerTraps: [
        {
          trap: "Confusing $AD \\cdot DC$ with $AD + DC$.",
      ...
      stepByStepGuide: [
        {
          ...
          action: "If diagonals intersect at $O$, write $\\frac{AO}{OC} = \\frac{BO}{OD}$. Cross-multiply to solve for unknown segment $x$.",
      ...
      examinerTraps: [
        {
          ...
          correction: "Perimeter is a ONE-DIMENSIONAL length! $\\frac{\\text{Perimeter}_1}{\\text{Perimeter}_2} = \\frac{s_1}{s_2}$ (NOT squared!). Only area ratios are squared: $\\frac{\\text{Area}_1}{\\text{Area}_2} = \\left(\\frac{s_1}{s_2}\\right)^2$."
        }
      ]
    }
  ]
